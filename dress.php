<?php 
  ...
  $page="dress.php";
	$sqlproductcount2 = mysqli_query($conn,"SELECT * FROM producttable WHERE productCategory = 'Dress'");
?>
...
<span style="font-size:25px;cursor:pointer;position:absolute;z-index:1;color:white;padding:5px 10px 5px 10px;border-radius:3px;margin:10px;" id="closenav" onclick="closeNav()">&#9776;</span>  
	<img src="img/colhead/dress.jpg" class="img-responsive" alt="Smiley face" id="head" height="500" width="1250">
<br>
<div class="content">
	<?php
